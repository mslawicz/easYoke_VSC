...
#define CFG_HW_USART1_HWFLOWCTL               UART_HWCONTROL_CTS
...
#define CFG_HW_USART1_CTS_PORT_CLK_ENABLE     __HAL_RCC_GPIOB_CLK_ENABLE
#define CFG_HW_USART1_CTS_PORT                GPIOB
#define CFG_HW_USART1_CTS_PIN                 GPIO_PIN_4
